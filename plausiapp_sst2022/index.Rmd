...
Once a __handful of municipalities (5) have completed the count__, a prediction of the final results for all areas can be made. 

The prediction of the yes-shares is than compared to the values reported by the municipalities.

→ __Deviations between the actual and the predicted yes share may indicate errors.__


```{r eval=T, echo=F, warning=F, message=F, fig.width=16, fig.height=4, dpi=250}
...
ggplot(gem_pred, aes(vorlage, error))+
  ...
  labs(title="Example : Deviation between predicted yes-Shares and reported values",
       ...
       x="",
       y="Deviation Prediction / Reported Result"
       )
```
