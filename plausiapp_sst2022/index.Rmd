...
date: '27.4.2022<br><br><br><a href="https://twitter.com/statistik_zh" style="text-decoration: none; border-bottom:"><i class="fa fa-twitter fa-fw"></i>@statistik_zh</a>'
output:
...
The project is hosted on __gitlab__ `r fontawesome::fa("gitlab", height="1em")` (Access upon request)

Two further Cantons have started using the PlausiApp this year:

- St. Gallen 
- Thurgau

By learning from the other Cantons experience we aim to improve the App to make its re-use even easier.
