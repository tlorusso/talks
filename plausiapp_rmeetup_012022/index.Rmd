...
- Small errors that do not deviate from the expected patterns might get overlooked

- But : many checks are built in a way to signal even small deviations
...
- __Making the PlausiApp accessible to other interested cantons__ 
  ...
  Focus on Cantons that use the same Vote Result Reporting Software as the Canton Zurich ("Wabsti")

- __Common standard for result verification data exports__ 

  Coordinative efforts to define a common standard (ECH) for result verification data exports, in order that the tool could be used by any canton irrespective of their result software.
