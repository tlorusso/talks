...
**... präsentieren** in Applikationen, Blogs.

???

Vom Sammeln der Daten (z.B. via Webscraping), Transformieren, über das Visualisieren (statisch / interaktiv) bis hin zur Erstellung von Webseiten (Blogs) bauen oder Applikationen um die Daten zu präsentieren.
